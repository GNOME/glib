		      ...
		      gpointer    data)
{
  ...
  g_print ("gio-test: ...Windows message for 0x%p: %d,%u,%ld\n",
...
window_procedure (HWND hwnd,
		  ...
		  LPARAM lparam)
{
  g_print ("gio-test: window_procedure for 0x%p: %d,%u,%ld\n",
	  ...
	  if (rand() % 100 < 5)
	    {
	      ...
	      WPARAM wparam = rand ();
	      LPARAM lparam = rand ();
	      g_print ("gio-test: child posting message %d,%u,%ld to 0x%p\n",
