 ...
 * GNotificationSound:
 *
 * `GNotificationSound` holds the sound that should be played when a notification
 ...
 *
 * `GNotification` using this `GNotificationSound` will play the sound in @file
 * when displayed.
 *
 ...
 *
 * `GNotification` using this `GNotificationSound` will play the sound in @bytes
 * when displayed.
 *
 * Returns: a new `GNotificationSound` instance
 *
 ...
 *
 * `GNotification using this `GNotificationSound` will play the default sound when displayed.
 *
 * Returns: a new `GNotificationSound` instance.
 *
 * Since: 2.84
