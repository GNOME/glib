 ...
 *
 * An example @pkcs11_uri would be "pkcs11:model=Model;manufacturer=Manufacture;serial=12345678;token=My%20Client%20Certificate;id=%01"
 *
 * Where the tokens layout is:
 *
 * ```
 * Object 0:
 *   URL: pkcs11:model=Model;manufacturer=Manufacture;serial=12345678;token=My%20Client%20Certificate;id=%01;object=AUTH%20key;type=private
 *   Type: Private key (RSA-2048)
 *   ID: 01
 *
 * Object 1:
 *   URL: pkcs11:model=Model;manufacturer=Manufacture;serial=12345678;token=My%20Client%20Certificate;id=%01;object=AUTH%20pubkey;type=public
 *   Type: Public key (RSA-2048)
 * 	 ID: 01
 *
 * Object 2:
 *   URL: pkcs11:model=Model;manufacturer=Manufacture;serial=12345678;token=My%20Client%20Certificate;id=%01;object=Certificate%20for%20Authentication;type=cert
 *   Type: X.509 Certificate (RSA-2048)
 *   ID: 01
 * ```
 *
 * Note that the private key is not accessed until usage
 * and may fail or require a PIN later.
 *
 * Returns: the new certificate, or %NULL on error
 *
 * Since: 2.64
 */
GTlsCertificate *
g_tls_certificate_new_from_pkcs11_uri (const gchar  *pkcs11_uri,
                                       GError      **error)
{
  GObject *cert;
  GTlsBackend *backend;
