...
{
  g_debug ("try_next_connection_or_finish: %d, %d, %p, %d", data->connection_in_progress, end_current_connection, data->successful_connections, data->enumeration_completed);
