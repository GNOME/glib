                           ...
                           gconstpointer         user_data)
{
  ...
  data.delay_ms = 50; /* High delay is just to ensure interleaving happens */
                               ...
                               gconstpointer         user_data)
{
  ...
  data.loop = fixture->loop;
  mock_resolver_set_ipv4_delay (fixture->mock_resolver, 25);
                               ...
                               gconstpointer         user_data)
{
  ...
  data.loop = fixture->loop;
  mock_resolver_set_ipv6_delay (fixture->mock_resolver, 25);
                                    ...
                                    gconstpointer         user_data)
{
  ...
  data.loop = fixture->loop;
  mock_resolver_set_ipv6_delay (fixture->mock_resolver, 200);
                                              ...
                                              gconstpointer         user_data)
{
  ...
  data.loop = fixture->loop;
  data.delay_ms = 500;
  mock_resolver_set_ipv4_delay (fixture->mock_resolver, 200);
