...
void
mock_resolver_set_ipv4_delay (MockResolver *self, guint delay_ms)
{
  self->ipv4_delay = delay_ms;
}
...
void
mock_resolver_set_ipv6_delay (MockResolver *self, guint delay_ms)
{
  self->ipv6_delay = delay_ms;
}
