...
{
  _g_generic_content_type_set_mime_dirs (dirs);
}
...
{
  return _g_generic_content_type_get_mime_dirs ();
}
...
g_content_type_equals (const gchar *type1,
                       const gchar *type2)
{
  return _g_generic_content_type_equals (type1, type2);
}
...
{
  return _g_generic_content_type_is_a (type, supertype);
}
...
{
  return _g_generic_content_type_is_mime_type (type, mime_type);
}
...
{
  return _g_generic_content_type_is_unknown (type);
}
...
{
  return _g_generic_content_type_get_description (type);
}
...
{
  return _g_generic_content_type_get_icon (type);
}
...
{
  return _g_generic_content_type_get_symbolic_icon (type);
}
...
{
  return _g_generic_content_type_get_generic_icon_name (type);
}
...
{
  return _g_generic_content_type_can_be_executable (type);
}
...
{
  return _g_generic_content_type_from_mime_type (mime_type);
}
...
{
  return _g_generic_content_type_guess (filename, data, data_size, result_uncertain);
}
...
{
  return _g_generic_content_types_get_registered ();
}
