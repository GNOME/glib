...
/* BOOLEAN:OBJECT (gmarshal-internal.list:1) */
void
...
/* BOOLEAN:OBJECT,FLAGS (gmarshal-internal.list:2) */
void
...
/* BOOLEAN:OBJECT,OBJECT (gmarshal-internal.list:3) */
void
...
/* BOOLEAN:POINTER,INT (gmarshal-internal.list:4) */
void
...
/* BOOLEAN:STRING (gmarshal-internal.list:5) */
void
...
/* BOOLEAN:UINT (gmarshal-internal.list:6) */
void
...
/* BOOLEAN:VOID (gmarshal-internal.list:7) */
void
...
/* INT:BOXED (gmarshal-internal.list:8) */
void
...
/* INT:OBJECT (gmarshal-internal.list:9) */
void
...
/* VOID:BOOLEAN,BOXED (gmarshal-internal.list:10) */
void
...
/* VOID:ENUM,OBJECT (gmarshal-internal.list:11) */
void
...
/* VOID:ENUM,OBJECT,OBJECT (gmarshal-internal.list:12) */
void
...
/* VOID:INT,INT,INT (gmarshal-internal.list:13) */
void
...
/* VOID:OBJECT,OBJECT (gmarshal-internal.list:14) */
void
...
/* VOID:OBJECT,OBJECT,ENUM (gmarshal-internal.list:15) */
void
...
/* VOID:OBJECT,OBJECT,STRING,STRING,VARIANT (gmarshal-internal.list:16) */
void
...
/* VOID:OBJECT,OBJECT,VARIANT,BOXED (gmarshal-internal.list:17) */
void
...
/* VOID:OBJECT,VARIANT (gmarshal-internal.list:18) */
void
...
/* VOID:POINTER,INT,STRING (gmarshal-internal.list:19) */
void
...
/* VOID:STRING,BOOLEAN (gmarshal-internal.list:20) */
void
...
/* VOID:STRING,BOXED (gmarshal-internal.list:21) */
void
...
/* VOID:STRING,BOXED,BOXED (gmarshal-internal.list:22) */
void
...
/* VOID:STRING,INT64,INT64 (gmarshal-internal.list:23) */
void
...
/* VOID:STRING,STRING,STRING,FLAGS (gmarshal-internal.list:24) */
void
...
/* VOID:STRING,STRING,VARIANT (gmarshal-internal.list:25) */
void
...
/* VOID:STRING,VARIANT (gmarshal-internal.list:26) */
void
...
/* VOID:UINT,UINT,UINT (gmarshal-internal.list:27) */
void
...
/* VOID:VARIANT,BOXED (gmarshal-internal.list:28) */
void
