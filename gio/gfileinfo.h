 ...
 * IO_REPARSE_TAG_MOUNT_POINT. This attribute is only available for
 * DOS file systems. Corresponding #GFileAttributeType
 * is %G_FILE_ATTRIBUTE_TYPE_BOOLEAN.
 **/
 ...
 * See the "Reparse Point Tags" docs.microsoft.com page for possible
 * reparse tag values. Corresponding #GFileAttributeType
 * is %G_FILE_ATTRIBUTE_TYPE_UINT32.
 **/
