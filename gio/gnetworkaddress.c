 ...
 *
 * Note that the results of resolved addresses may be cached as long as this
 ...
 */
static GList *
inet_addresses_to_inet_socket_addresses (GNetworkAddress *addr, GList *addresses)
{
...
g_network_address_parse_sockaddr (GNetworkAddress *addr)
{
  ...
  g_assert (!addr->priv->cached_sockaddrs);
