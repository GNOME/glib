 ...
 *
 * Obtains a suffix completion for @initial_text from @completer. Suffix will
 * an empty string if there's no shared suffix among matching completions. If
 * there's no matching completions anyway, %NULL is returned.
 *  
