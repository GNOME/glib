...
/* TODO just refactor all of this to use a directory array initialised in one place */
static void
 ...
 * picked up by xdg_mime_init() next time public API is called. TODO
 * dirs include the `/mime` subdirectory*/
void
