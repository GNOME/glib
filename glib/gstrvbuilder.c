 ...
 */
void
g_strv_builder_append (GStrvBuilder *builder,
                       const gchar  *value)
{
  g_strv_builder_insert (builder, -1, value);
}

/**
 * g_strv_builder_prepend:
 * @builder: a #GStrvBuilder
 * @value: a string.
 *
 ...
 */
void
g_strv_builder_prepend (GStrvBuilder *builder,
                        const gchar  *value)
{
  g_strv_builder_insert (builder, 0, value);
}

/**
 * g_strv_builder_insert:
 * @builder: a #GStrvBuilder
 * @index_: the index to place the string at, or -1 to append
 * @value: a string.
 *
 * Insert a string into the array at the given index.
 *
 * Since 2.66
 */
void
g_strv_builder_insert (GStrvBuilder *builder,
                       gint          index,
                       const gchar  *value)
{
  g_ptr_array_insert (builder->array, index, g_strdup (value));
}
