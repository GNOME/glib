 ...
 *
 * void test_error_copy (GError *dest_error, const GError *src_error)
 * {
 ...
 * }
 *
 * void test_error_free (gpointer error_ptr)
 * {
 *   // nothing to do here
 * }
 *
...
error_domain_register (GQuark          error_quark,
                       gsize           error_type_size,
                       GErrorCopy      error_type_copy,
                       GDestroyNotify  error_type_destroy)
{
  ...
  if (error_domain_lookup (error_quark) == NULL)
    {
      ...
      info->destroy = error_type_destroy;
 ...
 * @error_type_destroy: a function destroying fields of the extended type
 *
 * This function registers an extended #GError type. @error_type_name
 * should not be freed. @error_type_size can not be lower the the size
 * of #GError. @error_type_copy is a function that receives both
 * original and a copy #GError and should copy the extra fields of the
 * extended type. The standard #GError fields are already
 * handled. @error_type_destroy receives the pointer to the extended
                                ...
                                GDestroyNotify  error_type_destroy)
{
  ...
  g_return_val_if_fail (error_type_destroy != NULL, 0);
  ...
  error_domain_register (error_quark, error_type_size, error_type_copy, error_type_destroy);
  return error_quark;
}
                    ...
                    va_list      args)
{
  ...
  error = g_error_allocate (domain, NULL);
                     ...
                     const gchar   *message)
{
  ...
  err = g_error_allocate (domain, NULL);
...
g_error_copy (const GError *error)
{
  ...
  copy = g_error_allocate (error->domain, &info);
