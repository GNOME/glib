 ...
 *
 * A wrapper for the POSIX f_sync() function (_commit() on Windows).
 * The f_sync() function is used to synchronize a file's in-core
 * state with that of the disk.
 *
 * See the C library manual for more details about f_sync().
 *
