...
#define aligned(x)        0, x - 1
  /* 'b' */ { fixed_aligned(1), 0 },   /* boolean */
  /* 'c' */ { not_a_type          },
  /* 'd' */ { fixed_aligned(8), 0 },   /* double */
  /* 'e' */ { not_a_type          },
  /* 'f' */ { not_a_type          },
  /* 'g' */ { unaligned,        0 },   /* signature string */
  /* 'h' */ { fixed_aligned(4), 0 },   /* file handle (int32) */
  /* 'i' */ { fixed_aligned(4), 0 },   /* int32 */
  /* 'j' */ { not_a_type          },
  /* 'k' */ { not_a_type          },
  /* 'l' */ { not_a_type          },
  /* 'm' */ { not_a_type          },
  /* 'n' */ { fixed_aligned(2), 0 },   /* int16 */
  /* 'o' */ { unaligned,        0 },   /* object path string */
  /* 'p' */ { not_a_type          },
  /* 'q' */ { fixed_aligned(2), 0 },   /* uint16 */
  /* 'r' */ { not_a_type          },
  /* 's' */ { unaligned,        0 },   /* string */
  /* 't' */ { fixed_aligned(8), 0 },   /* uint64 */
  /* 'u' */ { fixed_aligned(4), 0 },   /* uint32 */
  /* 'v' */ { aligned(8),       0 },   /* variant */
  /* 'w' */ { not_a_type          },
  /* 'x' */ { fixed_aligned(8), 0 },   /* int64 */
  /* 'y' */ { fixed_aligned(1), 0 },   /* byte */
#undef fixed_aligned
#undef not_a_type
#undef unaligned
#undef aligned
