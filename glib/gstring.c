 ...
 * @val: bytes to insert
 * @len: number of bytes of @val to insert, or -1 for entire of @val
 *
 ...
 * @string: a #GString
 * @val: bytes to append
 * @len: number of bytes of @val to use, or -1 for entire of @val
 *
 ...
 * @len: number of bytes in @val to prepend, or -1 for entire of @val
 *
