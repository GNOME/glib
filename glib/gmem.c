 ...
 *
 * Since GLib 2.46 g_malloc() is hardcoded to always use the system memory
 * allocator. Memory allocated by malloc() and g_malloc() can be used
 * interchangeably, and released with a call to either free() or g_free().
 */
