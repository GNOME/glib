...
#define g_atomic_int_get(atomic) \
  (G_GNUC_EXTENSION ({                                                       \
    ...
    __atomic_load ((gint *)(atomic), &val, __ATOMIC_SEQ_CST);                \
    (gint) val;                                                              \
  }))
#define g_atomic_int_set(atomic, newval) \
  (G_GNUC_EXTENSION ({                                                       \
    G_STATIC_ASSERT (sizeof *(atomic) == sizeof (gint));                     \
    gint val = (gint) (newval);                                              \
    (void) (0 ? *(atomic) ^ (newval) : 1);                                   \
    __atomic_store ((gint *)(atomic), &val, __ATOMIC_SEQ_CST);               \
  }))
...
#define g_atomic_pointer_get(atomic) \
  (G_GNUC_EXTENSION ({                                                       \
    ...
    gpointer val;                                                            \
    __atomic_load ((gpointer *)(atomic), &val, __ATOMIC_SEQ_CST);            \
    val;                                                                     \
  }))
#define g_atomic_pointer_set(atomic, newval) \
  (G_GNUC_EXTENSION ({                                                       \
    G_STATIC_ASSERT (sizeof *(atomic) == sizeof (gpointer));                 \
    gpointer val = (gpointer)(newval);                                       \
    (void) (0 ? (gpointer) *(atomic) : NULL);                                \
    __atomic_store ((gpointer *)(atomic), &val, __ATOMIC_SEQ_CST);           \
  }))
