...
test_clear_pointer_full (void)
{
  ...
  g_clear_queue_full (&queue, free_func);
...
int main (int argc, char *argv[])
{
  ...
  g_test_add_func ("/queue/clear-pointer", test_clear_pointer);
  g_test_add_func ("/queue/clear-pointer-full", test_clear_pointer_full);
