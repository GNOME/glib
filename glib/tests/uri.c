...
test_uri_parse_params (void)
{
  ...
  params = g_uri_parse_params ("", 0, "&", G_URI_PARAMS_NONE);
  g_assert_cmpint (g_hash_table_size (params), ==, 0);
  g_hash_table_unref (params);

  params = g_uri_parse_params ("p1=foo&p2=bar", -1, "&", G_URI_PARAMS_NONE);
  ...
  params = g_uri_parse_params ("p1=foo;p2=bar&p3=baz", -1, "&;", G_URI_PARAMS_NONE);
  ...
  params = g_uri_parse_params ("foo", -1, "&", G_URI_PARAMS_NONE);
