...
test_uri_is_valid (void)
{
  ...
  g_assert_true (g_uri_is_valid ("http://[fe80::dead:beef%wef]/", G_URI_FLAGS_NONE, NULL));
  g_assert_false (g_uri_is_valid ("http://[fe80::dead:beef%wef]/", G_URI_FLAGS_PARSE_STRICT, &error));
  g_assert_error (error, G_URI_ERROR, G_URI_ERROR_BAD_HOST);
  g_clear_error (&error);
