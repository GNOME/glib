 ...
 * g_array_steal:
 * @array: a #GArray.
 * @len: (optional): pointer to retrieve the number of elements of the original array
 *
 ...
 */
gpointer
g_array_steal (GArray *array, gsize *len)
{
 ...
 */
gpointer *
g_ptr_array_steal (GPtrArray *array, gsize *len)
{
 ...
 */
guint8 *
g_byte_array_steal (GByteArray *array, gsize *len)
{
