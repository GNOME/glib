 ...
 *
 * Adds all pointers in array_to_extend to the end of the pointer array.
 * The array will grow in size automatically if necessary.
 *
 * Since: 2.62
 **/
void
g_ptr_array_extend (GPtrArray  *array,
                    GPtrArray  *array_to_extend)
{
  g_return_if_fail (array);
  g_ptr_array_foreach(array_to_extend, (GFunc) add_ptr, array);
}
