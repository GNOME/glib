  ...
  do
    {
      ...
      /* Bail out if: the lookup was successful, orif the user id can't be found
       * (should be pretty rare case actually), or if the buffer should be big
       * enough and yet lookups are still not successful.
       */
