...
#define SKIP____register_transform_func(type1,type2,transform_func)     /* skip questionable transforms */ \
  ...
  g_value_register_transform_func (G_TYPE_ULONG,        G_TYPE_USHORT,          value_transform_ulong_ushort);
  ...
  g_value_register_transform_func (G_TYPE_INT64,        G_TYPE_USHORT,          value_transform_int64_ushort);
  ...
  g_value_register_transform_func (G_TYPE_UINT64,       G_TYPE_SHORT,           value_transform_uint64_short);
  g_value_register_transform_func (G_TYPE_UINT64,       G_TYPE_USHORT,          value_transform_uint64_ushort);
  ...
  g_value_register_transform_func (G_TYPE_FLAGS,        G_TYPE_USHORT,          value_transform_ulong_ushort);
  ...
  g_value_register_transform_func (G_TYPE_FLOAT,        G_TYPE_USHORT,          value_transform_float_ushort);
  ...
  g_value_register_transform_func (G_TYPE_DOUBLE,       G_TYPE_SHORT,           value_transform_double_short);
  g_value_register_transform_func (G_TYPE_DOUBLE,       G_TYPE_USHORT,          value_transform_double_ushort);
