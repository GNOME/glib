...
G_DECLARE_FINAL_TYPE (TestAutolistCleanup, test_autolist_cleanup, TEST, AUTOLIST_CLEANUP, GObject);

struct _TestAutolistCleanup
{
  GObject parent_instance;
};

G_DEFINE_TYPE (TestAutolistCleanup, test_autolist_cleanup, G_TYPE_OBJECT)

static void
test_autolist_cleanup_class_init (TestAutolistCleanupClass *class)
{}

static void
test_autolist_cleanup_init (TestAutolistCleanup *tac)
{
    tac = G_TYPE_INSTANCE_GET_PRIVATE (tac,
                                       test_autolist_cleanup_get_type (),
                                       TestAutolistCleanup);
}
