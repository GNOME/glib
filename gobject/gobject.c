...
_weak_ref_release_all_state_has (WeakRefReleaseAllState *release_all_state, WeakRefReleaseAllState *needle)
{
      ...
      if (release_all_state->remaining_to_notify == G_MAXUINT)
      ...
      else
        {
          if (release_all_state->remaining_to_notify == 0u)
            {
#ifdef G_ENABLE_DEBUG
              g_assert (!_weak_ref_release_all_state_has (wstack->release_all_states, release_all_state));
#endif
              return NULL;
            }
#ifdef G_ENABLE_DEBUG
