 ...
 * objects.
 *
 * #GWeakRefs are reset before calling #GObjectClass.dispose. If the object's
 * #GObjectClass.dispose method results in additional references to the object
 * being held (‘re-referencing’), any #GWeakRefs taken before it was disposed
 * will continue to point to %NULL. If during disposal the object gets
 * re-referenced and resurrected, any #GWeakRefs taken during disposal will be
 * set until the reference count drops towards zero again and
